...
class telegramBot
{
   ...
   * @return Array
   */
  public function sendMessage($chat_id, $text,$reply_markup = null, $parse_mode = null, $disable_web_page_preview = false, $reply_to_message_id = null)
  {
  ...
  public function answer_query($callback_query_id, $text,$show_alert = false)
  {
  
    $params = compact('callback_query_id', 'text', 'show_alert');

    return $this->sendRequest('answerCallbackQuery', $params);
  }

public function edit_markap($chat_id, $message_id,$text,$reply_markup = null)
  {
    $parse_mode ='HTML';
    if (is_null($reply_markup)) {
      $params = compact('chat_id', 'message_id', 'text','parse_mode');
    }else{
      $params = compact('chat_id', 'message_id', 'text', 'reply_markup','parse_mode');
    }
  ...
  {
    $data = compact('chat_id', 'user_id');
    //file_put_contents('resddult.txt',json_encode($this->sendRequest('getChatMember',$data)).PHP_EOL.PHP_EOL,FILE_APPEND);
   ...
   * @return Array
   */
  public function sendAudio($chat_id, $audio,$caption, $duration = null, $performer = null, $title = null, $reply_to_message_id = null, $reply_markup = null)
  {
    $data = compact('chat_id', 'audio','caption', 'duration', 'performer', 'title', 'reply_to_message_id', 'reply_markup');
 ...
 function InlineKeyboardMarkup($buttons) {
  $keyboard = [
      'inline_keyboard' => [],
  ];
  ...
  foreach ($buttons as $row) {
      ...
      $keyboard['inline_keyboard'][] = $buttonRow;
  }
